...
<body>
	<h4>上传文件</h4>
	<form name="userForm" onsubmit="return lxValidate(this);" id="userForm" action="${pageContext.request.contextPath}/user/addshopimg.do" method="post" enctype="multipart/form-data">
