...
<body>
	<h4>上传文件</h4>
	<form name="userForm"  onsubmit="return lxValidate(this);" id="userForm" action="${pageContext.request.contextPath}/adminusers/upload2.do" method="post" enctype="multipart/form-data">
