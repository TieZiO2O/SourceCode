...
<html>
  ...
  <body>
	...
	action="${pageContext.request.contextPath}/adminusers/shopper_addOpt.do"onsubmit="return chkAll();"
	  ${pageContext.request.contextPath}/adminusers/dailyAbc_addOpt.do"onsubmit="return chkAll();
	  -->
		
		<form id="form1" method="post" action="${pageContext.request.contextPath}/adminusers/dailyAbc_addOpt.do"onsubmit="return chkAll();" >
		<table width="60%">
			<tr>
			...
			<tr>
				<td colspan="2" width="40%">
					 ...
					 <!-- <input type="button" name="submit" onclick="onClik();" value="添加"/>  -->
				</td>
			</tr>
		</table>
		</form>
