...
/////////////////////0703
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/adminusers/property_addOpt.do",
            type:"post",
            dataType:"json",
	...
	action="${pageContext.request.contextPath}/adminusers/shopper_addOpt.do"onsubmit="return chkAll();"
	  -->
		...
		<table width="60%">
			...
			<!-- <tr>
				<th width="40%" align="right">所属模块</th>
				<td>
					<input id="contentName" name="contentName" type="text"  />
					<select id="parent" name="parent" onchange="javascript:selectedchange(parent,contentName);" style="width: 80px"></select>
			...
			<tr>
				<td colspan="2" width="40%">
					...
					<input id="pAdd" type="button" name="submit" onclick="onClik();" value="添加"/>
				</td>
			</tr>
		</table>
		</form>
