...
<body>
	<h4>上传文件</h4>
	<form name="userForm"  onsubmit="return lxValidate(this);" id="userForm" action="${pageContext.request.contextPath}/adminusers/uploadAd.do" method="post" enctype="multipart/form-data">
		选择文件：<input type="file" name="file" id="file" onchange="filesize(this)">
